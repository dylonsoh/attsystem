...
<asp:Content ID="BodyContent" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:GridView ID="peopleNameList" runat="server" Style="height: 153px; width: 164px; position: absolute; left: 472px; top: 365px" BackColor="Aqua" BorderColor="Black" BorderStyle="Dotted" BorderWidth="2px" AutoGenerateColumns="False" DataSourceID="pplNameListDataSource">
        <Columns>
            <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" />
        </Columns>
    </asp:GridView>
