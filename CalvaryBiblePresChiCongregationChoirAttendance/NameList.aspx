...
<asp:Content ID="BodyContent" ContentPlaceHolderID="BodyContent" Runat="Server">
    ...
    <asp:Label ID="Label3" runat="server" Font-Bold="False" Font-Italic="True" Font-Size="XX-Large" style="width: 865px; height: 39px; position: absolute; left: 1015px; top: 724px" Text="Note :  Contact your admin if deletion or update is needed"></asp:Label>
    <asp:Label ID="Label8" runat="server" Font-Bold="False" Font-Italic="True" Font-Size="XX-Large" style="width: 865px; height: 84px; position: absolute; left: 1015px; top: 804px" Text="Note :  Look at latest student ID and add 1 to the back, i.e Alto_08 after Alto_07"></asp:Label>
    ...
    <asp:Button ID="updatePerson" runat="server" style="width: 253px; height: 44px; position: absolute; left: 1128px; top: 561px" Text="Update Person" Font-Bold="True" Font-Size="XX-Large" OnClick="updatePerson_Click" />
    ...
    <asp:ListBox ID="nameListBox" runat="server" AutoPostBack="True" Font-Bold="False" Font-Size="XX-Large" Font-Underline="True" style="width: 472px; height: 474px; position: absolute; left: 53px; top: 252px" DataSourceID="personsList" DataTextField="Name" DataValueField="Name"></asp:ListBox>
    <asp:ListBox ID="studentIDListBox" runat="server" AutoPostBack="True" Font-Bold="False" Font-Size="XX-Large" Font-Underline="True" style="width: 472px; height: 475px; position: absolute; left: 543px; top: 252px" DataSourceID="studentIDDataSource1" DataTextField="Student_ID" DataValueField="Student_ID"></asp:ListBox> 
    ...
    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="XX-Large" style="width: 161px; height: 36px; position: absolute; left: 50px; top: 160px" Text="Name List"></asp:Label>
    <asp:Label ID="Label6" runat="server" Font-Bold="True" Font-Size="XX-Large" style="width: 161px; height: 63px; position: absolute; left: 550px; top: 160px" Text="Student ID"></asp:Label>
